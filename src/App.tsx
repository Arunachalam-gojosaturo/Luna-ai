    ...
    try {
      const response = await fetch("http://localhost:3000/api/luna/command", {
        ...
        body: JSON.stringify({
          ...
          geminiKey: settingsConfig.geminiKey,
          openRouterKey: settingsConfig.openRouterKey,
          githubToken: settingsConfig.githubPat,
          nvidiaKey: settingsConfig.nvidiaKey,
          cerebrasKey: settingsConfig.cerebrasKey,
          bazaarlinkKey: settingsConfig.bazaarlinkKey,
          togetherKey: settingsConfig.togetherKey,
          cohereKey: settingsConfig.cohereKey,
